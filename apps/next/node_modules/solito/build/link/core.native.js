...
function LinkCore({ children, href, as, Component, replace, experimental, target, rel, style, ...props }) {
    ...
    return (_jsx(Component, { accessibilityRole: "link", style: style, ...props, onPress: (e) => {
