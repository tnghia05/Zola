...
const SolitoImage = forwardRef(function SolitoImage({ contentFit, resizeMode = 'contain', fill, style, onLayout, onError, contentPosition, ...props }, ref) {
    const { loader } = useSolitoImageContext();
    return (_jsx(NextImage, { ...props, ref: ref, loader: props.loader ?? loader, fill: fill, src: props.src, onError: onError, style: {
            objectFit: contentFit || objectFitFromResizeMode(resizeMode),
            objectPosition: getObjectPositionFromContentPositionObject(resolveContentPosition(contentPosition)),
            ...style,
        } }));
});
