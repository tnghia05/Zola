  ...
  return (
    <View style={groupStyles.container}>
      ...
      <View style={[groupStyles.controls, { bottom: insets.bottom + 24 }]}>
        ...
        >
          <Text style={groupStyles.controlText}>{isAudioEnabled ? '🎤' : '🔇'}</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[
            groupStyles.controlButton,
          ...
          disabled={!isConnected}
        >
          <Text style={groupStyles.controlText}>{isVideoEnabled ? '📹' : '📷'}</Text>
        </TouchableOpacity>
        <TouchableOpacity
          ...
          disabled={isEnding}
        >
          <Text style={groupStyles.controlText}>📞</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
...
function P2PCallContent({ route, navigation }: Props) {
  ...
  const scheduleOfferRetry = () => {
    ...
    if (isIncoming) return; // chỉ caller mới chủ động tạo offer
  ...
  useEffect(() => {
    ...
    console.log('📞 [CALLSCREEN] Window location:', typeof window !== 'undefined' && (window as any)?.location ? (window as any).location.href : 'N/A');
    ...
    <View style={styles.container}>
      ...
      <View style={[
        ...
        <Text style={[
          ...
          {callState === 'ringing' && (isIncoming ? 'Cuộc gọi đến...' : 'Đang gọi...')}
        ...
        {callState === 'ringing' && isIncoming && (
          <>
            <TouchableOpacity 
              ...
              activeOpacity={0.7}
            >
              <Text style={[styles.controlText, isMobile && styles.controlTextMobile]}>✓</Text>
            </TouchableOpacity>
            <TouchableOpacity 
              style={[
                styles.controlButton, 
            ...
            {isMobile ? (
              ...
              >
                ...
                <TouchableOpacity 
                  ...
                  activeOpacity={0.7}
                >
                  <Text style={styles.controlTextMobile}>🔄</Text>
                </TouchableOpacity>
