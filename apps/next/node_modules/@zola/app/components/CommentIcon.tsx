...
// Sử dụng SVG từ Figma với khả năng đổi màu qua currentColor
// Icon sẽ tự động đổi màu theo text color của parent element
...
export const CommentIcon = ({ 
  ...
  return (
    ...
    >
      {/* SVG từ Figma - đã đổi fill="#0966FF" thành fill="currentColor" */}
      <path
        fillRule="evenodd"
        clipRule="evenodd"
