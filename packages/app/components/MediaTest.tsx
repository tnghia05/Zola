...
export function MediaTest() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
      <h1 style={{ color: '#fff', marginBottom: '20px' }}>Media Test</h1>
      ...
      <div style={{ 
        ...
        <h2 style={{ color: '#fff', marginBottom: '15px', fontSize: '18px' }}>Chọn thiết bị</h2>
        ...
        <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', marginBottom: '15px' }}>
          ...
          <div style={{ flex: '1', minWidth: '250px' }}>
            ...
            <select
              ...
              disabled={!devicesLoaded || audioDevices.length === 0}
              style={{
                width: '100%',
                padding: '8px',
                backgroundColor: '#1a1a1a',
            ...
            >
              {!devicesLoaded ? (
                ...
                <option>Không có microphone</option>
              ) : (
                <>
                  <option value="">Mặc định</option>
      ...
      {videoStream && (
        <div style={{ marginBottom: '20px' }}>
          <h2 style={{ color: '#fff', marginBottom: '10px' }}>Video Stream</h2>
          <video
            ref={videoRef}
            autoPlay
            playsInline
      ...
      <div style={{ marginBottom: '20px', color: '#fff' }}>
        ...
        <div>
          <strong>Video Stream:</strong> {videoStream ? '✅ Active' : '❌ None'}
        </div>
        <div>
          <strong>Audio Stream:</strong> {audioStream ? '✅ Active' : '❌ None'}
        </div>
        <div>
      ...
      <div style={{ marginTop: '20px' }}>
        <h2 style={{ color: '#fff', marginBottom: '10px' }}>Logs</h2>
        <div
          style={{
            backgroundColor: '#1a1a1a',
        ...
        >
          {logs.length === 0 ? (
            <div style={{ color: '#666' }}>No logs yet. Click a test button to start.</div>
          ) : (
            logs.map((log, index) => (
