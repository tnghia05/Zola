...
export function IncomingCallModal() {
    ...
    return (_jsx("div", { style: {
            ...
            e.stopPropagation();
                ...
                border: '1px solid rgba(255, 255, 255, 0.1)',
            }, onClick: (e) => e.stopPropagation(), children: [_jsxs("div", { style: { textAlign: 'center', marginBottom: '24px' }, children: [callerAvatar ? (_jsx("img", { src: callerAvatar, alt: callerName, style: {
                                width: '80px',
                                height: '80px',
                                borderRadius: '50%',
                                margin: '0 auto 16px',
                                ...
                                fontWeight: 'bold',
                                color: '#fff',
                            }, children: callerName.charAt(0).toUpperCase() }), _jsx("h2", { style: { color: '#fff', margin: '0 0 8px 0', fontSize: '20px', fontWeight: '600' }, children: callerName }), _jsxs("p", { style: { color: 'rgba(255, 255, 255, 0.7)', margin: 0, fontSize: '14px' }, children: ["Cu\u1ED9c g\u1ECDi ", incomingCall.type === 'video' ? 'video' : 'audio', " \u0111\u1EBFn"] })] }), _jsxs("div", { style: {
                        display: 'flex',
                        gap: '12px',
                        justifyContent: 'center',
                    }, children: [_jsx("button", { onClick: handleReject, disabled: isAccepting || isRejecting, style: {
                                width: '56px',
                                height: '56px',
                                borderRadius: '50%',
                            ...
                            }, title: isRejecting ? 'Đang từ chối...' : 'Từ chối', children: _jsx("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", children: _jsx("path", { d: "M18 6L6 18M6 6L18 18", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }) }), _jsx("button", { onClick: handleAccept, style: {
                                width: '56px',
                                height: '56px',
                                borderRadius: '50%',
                                ...
                                e.currentTarget.style.transform = 'scale(1)';
                            }, title: "Ch\u1EA5p nh\u1EADn", children: _jsx("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", children: _jsx("path", { d: "M20 6L9 17L4 12", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }) })] })] }) }));
}
