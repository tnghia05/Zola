...
export function useWebRTC({ callId, conversationId: _conversationId, isInitiator, localUserId: _localUserId, remoteUserId, videoDeviceId, audioDeviceId, }) {
    ...
    const processedFilterStreamRef = useRef(null);
    const filterCanvasRef = useRef(null);
    const filterVideoRef = useRef(null);
    const filterAnimationFrameRef = useRef(null);
    ...
    const startFilterProcessing = useCallback((filter) => {
    ...
    // ============================================================================
    const handleGetUserMediaError = useCallback((err) => {
    ...
    const requestOffer = useCallback((reason) => {
        const socket = socketRef.current;
        if (!socket) {
